...
public class ConsumerRestTemplateMS3Controller {
    ...
    public ConsumerRestTemplateMS3Controller(@Qualifier("restTemplate") RestTemplate restTemplate,
    ...
    public String callMs3(@Parameter(hidden = true) @RegisteredOAuth2AuthorizedClient("consumer-resttemplate") OAuth2AuthorizedClient authorizedClient) {
        ...
        ResponseEntity<String> response = restTemplate.exchange(
        		serviceParamsProperties.getGatewayOauth2().getUri().concat("/ms3/gr-ms3-resource/protected/get"),
                HttpMethod.GET,
                entity,
                String.class
        );
    ...
    public String callMs3Public() {
        ...
        String url = serviceParamsProperties.getGatewayOauth2().getUri().concat("/ms3/gr-ms3-resource/public/get");
