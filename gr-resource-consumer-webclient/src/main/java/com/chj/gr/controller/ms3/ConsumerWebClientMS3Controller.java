...
public class ConsumerWebClientMS3Controller {
	...
	public ConsumerWebClientMS3Controller(WebClient webClient, ServiceParamsProperties serviceParamsProperties) {
...
//                .get()
//                .uri(serviceParamsProperties.getGatewayOauth2().getUri().concat("/ms3/gr-ms3-resource/protected/get"))
